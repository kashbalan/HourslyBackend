...
class User(db.Model):
    ...
    # FIX: Corrected relationships to match back_populates in link tables
...
class Course(db.Model):
    ...
    def serialize(self):
        ...
        """
        # FIX: Fetch students from the dedicated relationship
        students = [
            uc.user.serialize_course_user() for uc in self.students_in_course
        ]
        
        # FIX: Fetch instructors and TAs from the dedicated relationship
        instructors = []
        tas = []
